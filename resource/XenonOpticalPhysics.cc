//**CAUTION************************************************************
//* 2022.10.7 Copied from Geant4 source by M.Kobayashi                *
//*  - G4 version v10.3.p03                                           *
//*  - change class name: G4->Xenon1t                                 *
//*  - add new variables and functions for PC reflection              * 
//*********************************************************************
//
// ********************************************************************
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(Xenon1tOpticalPhysics);


//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

Xenon1tOpticalPhysics::Xenon1tOpticalPhysics(G4int verbose, const G4String& name)
  : G4VPhysicsConstructor(name),
    ...
    fInvokeSD(true),
    //fPCRefProc(true),//Masatoshi Kobayashi for photocathode reflection
    fSaveAllPCProc(false),//Masatoshi Kobayashi for photocathode reflection
    fModPCRef(false),//Masatoshi Kobayashi for photocathode reflection
    ...
    fScintillationStackPhotons(true)
{
  ...
  fMessenger = new Xenon1tOpticalPhysicsMessenger(this);
...
Xenon1tOpticalPhysics::~Xenon1tOpticalPhysics()
{
  delete fMessenger;
}
...
void Xenon1tOpticalPhysics::PrintStatistics() const
{
...
void Xenon1tOpticalPhysics::ConstructParticle()
{
...
void Xenon1tOpticalPhysics::ConstructProcess()
{
// Construct optical processes.

  if(verboseLevel>0)
         G4cout <<"Xenon1tOpticalPhysics:: Add Optical Physics Processes"<< G4endl;
  ...
  //Masatoshi Kobayashi for PC reflection
  Xenon1tOpBoundaryProcess* OpBoundaryProcess = new Xenon1tOpBoundaryProcess();
  ...
  /*
  if(fPCRefProc){
	G4cout<<"Xenon1tOpticalPhysics: Set fPCRefProc as "<<fPCRefProc<<", Thin layer reflection model will be used at PMT Photocathode"<<G4endl;
  }else{
	G4cout<<"Xenon1tOpticalPhysics: Set fPCRefProc as "<<fPCRefProc<<", Simple Absorption model will be used at PMT Photocathode"<<G4endl;
  }
  OpBoundaryProcess->SetPCRefProc(fPCRefProc);
  */
  if(fSaveAllPCProc){
	G4cout<<"Xenon1tOpticalPhysics: Set fSaveAllPCProc as "<<fSaveAllPCProc<<", All process result at PC will be saved."<<G4endl;
	G4cout<<"Caution: pmthitsStatus is storing all process at PC, but photons will be killed the after reflection at PC. "<<G4endl;
  }
  OpBoundaryProcess->SetSaveAllPCProc(fSaveAllPCProc);

  if(fModPCRef){
	G4cout<<"Xenon1tOpticalPhysics: Set ModPCRef as "<<ModPCRefName<<G4endl;
  }
  OpBoundaryProcess->SetModPCRef(fModPCRef,ModPCRefName);
  ...
  if (!pManager) {
     ...
     G4Exception("Xenon1tOpticalPhysics::ConstructProcess()","",
...
void Xenon1tOpticalPhysics::SetScintillationYieldFactor(G4double yieldFactor)
{
...
void Xenon1tOpticalPhysics::SetScintillationExcitationRatio(G4double excitationRatio)
{
...
void Xenon1tOpticalPhysics::SetMaxNumPhotonsPerStep(G4int maxNumPhotons)
{
...
void Xenon1tOpticalPhysics::SetMaxBetaChangePerStep(G4double maxBetaChange)
{
...
void Xenon1tOpticalPhysics::SetWLSTimeProfile(G4String profile)
{
/// Set the WLS time profile (delta or exponential)
  fProfile = profile;
}

//void Xenon1tOpticalPhysics::AddScintillationSaturation(G4EmSaturation* saturation)
//{
///// Adds Birks Saturation to the G4Scintillation Process
//  G4Scintillation::AddSaturation(saturation);
//}

void Xenon1tOpticalPhysics::
...
void Xenon1tOpticalPhysics::SetTrackSecondariesFirst(G4OpticalProcessIndex index,
...
void Xenon1tOpticalPhysics::SetFiniteRiseTime(G4bool finiteRiseTime)
{
  fFiniteRiseTime = finiteRiseTime;
  //G4Scintillation::SetFiniteRiseTime(finiteRiseTime);
}

void Xenon1tOpticalPhysics::SetInvokeSD(G4bool invokeSD)
{
  fInvokeSD = invokeSD;
}

/* //Masatoshi Kobayashi for photocathode reflection
void Xenon1tOpticalPhysics::SetPCRefProc(G4bool pcrefproc)
{
  fPCRefProc = pcrefproc; 
}
*/

//Masatoshi Kobayashi for photocathode reflection
void Xenon1tOpticalPhysics::SetSaveAllPCProc(G4bool saveallpcproc)
{
  fSaveAllPCProc = saveallpcproc; 
}

void Xenon1tOpticalPhysics::SetModPCRef(G4bool modpcref,G4String modpcrefname)
{
    fModPCRef=modpcref;
    ModPCRefName=modpcrefname;
}

void Xenon1tOpticalPhysics::SetCerenkovStackPhotons(G4bool stackingFlag)
{
  fCerenkovStackPhotons = stackingFlag;
}

void Xenon1tOpticalPhysics::SetScintillationStackPhotons(G4bool stackingFlag)
{
  fScintillationStackPhotons = stackingFlag;
}

void Xenon1tOpticalPhysics::Configure(G4OpticalProcessIndex index, G4bool isUse)
{
