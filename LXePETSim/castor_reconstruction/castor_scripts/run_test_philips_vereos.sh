...
datafile="-df philips_vereos_sim.cdh"
...
output="-fout philips_vereos_sim_data"
...
post="-conv gaussian,6.,6.,3.5::post"
...
echo "=============================================================================================="
${recon} ${verbose} ${datafile} ${output} ${last_it} ${iteration} ${voxels_number} ${fov_size} ${offset} ${optimizer} ${projector} ${psf} ${post} ${thread} ${out_mask_axial} ${out_flip}
